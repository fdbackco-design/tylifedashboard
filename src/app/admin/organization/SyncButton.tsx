  ...
  return (
    <div className="flex flex-col items-stretch sm:items-end gap-2">
      <button
        onClick={handleSync}
        disabled={loading}
        className="w-full sm:w-auto px-4 py-2 text-sm rounded-lg bg-slate-800 text-white hover:bg-slate-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
